...
func addServerFlags(flags *pflag.FlagSet) {
	...
	flags.String("frontend-node-addr", "", "data-node address used by the frontend gateway; defaults to --node-addr")
	flags.String("node-addr", "127.0.0.1:7403", "data-node HTTP listen address")
